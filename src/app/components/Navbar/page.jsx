                ...
                <div className='block md:hidden py-4'>
                    <div className="w-full mx-auto flex items-center justify-between relative px-4">
                        ...
                        <div className="flex items-center">
                            <button onClick={toggleMenu} className="text-2xl cursor-pointer text-[#383838] z-[110] p-2 -mr-2 focus:outline-none" aria-expanded={show} aria-label={show ? "Close Menu" : "Open Menu"} >
                                {show ? <RxCross1 /> : <GiHamburgerMenu />}
                            </button>

                            <div className={`fixed inset-0 w-full h-screen bg-white transition-transform duration-500 ease-[cubic-bezier(0.19,1,0.22,1)] z-[105] ${show ? 'translate-x-0' : 'translate-x-full'}`}>
                                <nav className="flex flex-col items-center justify-center h-full">
                                    <ul className="flex flex-col items-center gap-8">
                                        <li>
                                            <Link onClick={toggleMenu} href="/" className="text-2xl text-[#383838] font-semibold hover:text-[#0045F2] transition-colors" >
                                                About
                                            </Link>
                                        </li>
                                        <li>
