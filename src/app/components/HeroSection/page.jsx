                ...
                <div className='container !max-w-[768px] !mr-0 !ml-auto flex flex-col justify-center px-6 lg:px-12 lg:pr-20'>
                    ...
                    >
                        ...
                        <div className='flex w-fit gap-2.5 items-center bg-white px-3 py-1.5 rounded-full shadow-sm'>
                            ...
                            <p className='text-[13px] font-semibold text-[#08144F]'>Backed by Y Combinator</p>
                        </div>

                        {/* Headline */}
                        <h1 className='text-[48px] md:text-[60px] lg:text-[72px] text-[#08144F] font-normal leading-[1.05] tracking-[-0.03em]'>
                            AI Agents Built For Intelligent Servicing
                        </h1>

                        {/* Description */}
                        <p className='text-[#565656] text-[16px] pr-50'>
